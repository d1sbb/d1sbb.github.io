...
(function($){
  $.fn.toc = function(options) {
    var defaults = {
      ...
      title: '<a href="#" ><i id="back-top" class="fa fa-arrow-up fa-lg" aria-hidden="true"></i></a><br><br><i class="fa fa-bars fa-lg" aria-hidden="true"></i>',
...
function toggleSize(div) {
  if (div.style.width === '20px' && div.style.height === '20px') {
